...
class Map extends Component {
  ...
  createMap = () => {
    ...
    selectAll("path.countries")
      .on("mouseover", (d) => this.centerBounds(svg, d, projection))
      .on("mouseout", (d) => this.clearCenterBounds(svg, d))
  };

  centerBounds(svg, d, projection) {
    const bounds = geoBounds(projection(d));
    const center = geoCentroid(projection(d));
    console.log(d);
