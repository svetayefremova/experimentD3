...
class Map extends Component {
  ...
  createMap = () => {
    ...
    const mapZoom = zoom()
      .translateTo(projection.translate())
      .scaleTo(projection.scale())
      .on("zoom", () => projection.translate(mapZoom.translate()).scale(mapZoom.scale()));

    select(svg).call(mapZoom);
    selectAll("path.graticule").attr("d", path);
    selectAll("path.countries").attr("d", path);
