...
class Linear extends Component {
  ...
  createLinear = () => {
    ...
    select(svg).append("g").attr("id", "xAxisG").call(axisBottom(xScale).tickSize(500).ticks(4));
    select(svg).append("g").attr("id", "yAxisG").call(axisRight(yScale).ticks(16).tickSize(500));
